...
- [WhatsApp Expense Capture](whatsapp-expense-capture.mmd): Upstream sender allowlisting, defensive registered-user checks, message interpretation, pending draft clarification, expense/income persistence, chat-based movement correction, and finance answers.
