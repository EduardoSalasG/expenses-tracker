...
Las superficies de gastos SHALL mostrar el filtro esencial para el período activo y permitir abrir filtros secundarios de concepto, categoría, subcategoría dependiente, moneda, tipo de medio de pago, opción de medio de pago y banco, sin ocultar filtros aplicados ni resultados. Los filtros soportados MUST conservarse en enlaces estables, usar nombres accesibles localizados, comunicar el estado de resultados y acotar los resultados a la cuenta financiera activa.
...
La superficie de ingresos SHALL permitir filtrar el período activo por concepto y moneda mediante divulgación progresiva, conservar los filtros soportados en enlaces estables, usar nombres accesibles localizados, comunicar el estado de resultados y limitar los resultados a la cuenta financiera activa.
