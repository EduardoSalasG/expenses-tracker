# task-first-financial-dashboard Specification

## Purpose

Presentar la información financiera del período según las decisiones que requiere la persona usuaria antes de la exploración analítica detallada.

## Requirements

### Requirement: Resumen de salud financiera del período
El dashboard SHALL presentar al inicio gastos, ingresos, balance neto y progreso de presupuesto para el período y cuenta activos, con etiquetas y valores localizados.
...
El dashboard SHALL mostrar acciones prioritarias derivadas exclusivamente de los datos ya cargados, incluyendo presupuestos comprometidos, cuotas próximas o saldos compartidos cuando correspondan.
...
Los gráficos SHALL permanecer disponibles después del resumen y prioridades, y MUST mantener sus alternativas textuales equivalentes, localizadas y navegables.
