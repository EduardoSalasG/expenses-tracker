...
import { refreshTokenSchema, requestOtpSchema, verifyOtpSchema } from '../schemas.js';
...
export class AuthController {
  ...
  requestOtp = async (request: Request, response: Response) => {
    ...
    response.json(await this.container.useCases.requestOtp.execute(body.phoneNumber));
  };
